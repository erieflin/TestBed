...
public class ConstructionProcess {
	private String id;
	private String formorianProgress;
	...
	public String getFormorianProgress() {
		return formorianProgress;
	}

	public void setFormorianProgress(String formorianProgress) {
		this.formorianProgress = formorianProgress;
	}
